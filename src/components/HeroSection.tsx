    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto animate-fade-in">
          ...
          <span className="text-orange-400 font-semibold mx-2">Machine Rentals</span> • 
        ...
        <p className="text-lg mb-12 text-gray-300 max-w-2xl mx-auto animate-fade-in">
          Trusted since 2004 — With deep roots in Ghana's construction and mining industries, 
          we deliver reliable equipment and expert-led services across West Africa.
        </p>
